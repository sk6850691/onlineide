...
class CreateBikesListing extends StatefulWidget {
  final collectionName;
  const CreateBikesListing({Key key,this.collectionName}) : super(key: key);

  @override
  _CreateBikesListingState createState() => _CreateBikesListingState();
}

class _CreateBikesListingState extends State<CreateBikesListing> {
