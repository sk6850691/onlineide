...
class CreateAdventureListing extends StatefulWidget {
  final collectionName;
  const CreateAdventureListing({Key key,this.collectionName}) : super(key: key);

  @override
  _CreateAdventureListingState createState() => _CreateAdventureListingState();
}

class _CreateAdventureListingState extends State<CreateAdventureListing> {
